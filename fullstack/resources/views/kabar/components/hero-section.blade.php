<!-- Header & Search -->
<div class="text-center max-w-3xl mx-auto mb-12 pt-6">
    <h1 class="font-h1 text-h1 text-on-surface mb-4">Kabar & Inspirasi Kebaikan</h1>
    <p class="font-body-lg text-body-lg text-on-surface-variant mb-8">
        Kumpulan artikel edukasi, kisah inspiratif, dan wawasan seputar dunia filantropi dan kerelawanan.
    </p>
    <form action="{{ url('/kabar') }}" method="GET" class="relative max-w-2xl mx-auto group">
        ...
        <input name="q" value="{{ $search ?? '' }}"
            ...
            placeholder="Cari artikel, topik, atau kata kunci..." type="text">
        <button type="submit"
