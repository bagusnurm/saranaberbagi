    ...
    <main class="flex-grow pt-32 pb-section-padding relative overflow-hidden">
        ...
        <div class="max-w-2xl mx-auto px-margin-mobile md:px-margin-desktop text-center relative z-10">
            <div class="bg-surface-container-lowest rounded-2xl p-8 md:p-12 shadow-lg border border-outline-variant/20">
                ...
                <div
                    class="animate-scaleIn mx-auto w-24 h-24 bg-primary-container rounded-full flex items-center justify-center mb-6 animate-pulse-slow">
                ...
                <p class="text-on-surface-variant mb-6 animate-fadeInUp delay-100">
                    Email konfirmasi telah dikirim ke <span
                        class="text-primary font-semibold">{{ $data['email'] }}</span>. Tim kami akan segera menghubungi
                ...
                <div class="bg-surface-container-low rounded-xl p-6 mb-8 text-left animate-fadeInUp delay-200">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between pt-3 border-t border-outline-variant/30">
                            ...
                            <span class="font-h3 text-h3 text-primary">Rp
                                {{ number_format($data['nominal'], 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="bg-gradient-to-r from-primary-container/30 to-secondary-container/30 rounded-xl p-6 mb-8 animate-fadeInUp delay-300">
                    <div class="flex items-center justify-center gap-3 mb-4">
                        ...
                        <span class="material-symbols-outlined text-primary text-3xl animate-float"
                            style="animation-delay: 0.5s;">favorite</span>
                    </div>
                    <p class="text-on-surface-variant mb-6">
                        Setiap kebaikan yang Anda sebarkan akan menjadi <span class="text-primary font-semibold">pahala
                            jariyah</span> yang mengalir tanpa henti. Ajak teman dan keluarga untuk ikut berkontribusi!
                    </p>

                    <!-- Share Buttons -->
                    <div class="flex flex-wrap justify-center gap-3">
                        <a href="https://wa.me/?text=Halo! Aku baru saja berdonasi di Sarana Berbagi. Yuk ikut berdonasi untuk pahala jariyah! {{ url('/donasi') }}"
                            target="_blank"
                            class="share-btn inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-3 rounded-xl font-semibold text-sm">
                            <span class="material-symbols-outlined">chat</span>
                            WhatsApp
                        </a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ url('/donasi') }}&quote=Yuk berdonasi di Sarana Berbagi untuk pahala jariyah!"
                            target="_blank"
                            class="share-btn inline-flex items-center gap-2 bg-[#1877F2] text-white px-5 py-3 rounded-xl font-semibold text-sm">
                            <span class="material-symbols-outlined">share</span>
                            Facebook
                        </a>
                        <a href="https://twitter.com/intent/tweet?text=Yuk berdonasi di Sarana Berbagi untuk pahala jariyah! {{ url('/donasi') }}"
                            target="_blank"
                            class="share-btn inline-flex items-center gap-2 bg-[#1DA1F2] text-white px-5 py-3 rounded-xl font-semibold text-sm">
                            <span class="material-symbols-outlined">alternate_email</span>
                            Twitter
                        </a>
                        <button onclick="copyLink()"
                            class="share-btn inline-flex items-center gap-2 bg-surface-container-high text-on-surface px-5 py-3 rounded-xl font-semibold text-sm border border-outline-variant">
                ...
                <div class="flex flex-col sm:flex-row gap-4 animate-fadeInUp delay-400">
                    <a href="{{ url('/') }}"
                        class="flex-1 bg-[#F59E0B] hover:bg-[#D97706] text-white font-label-sm text-label-sm px-8 py-4 rounded-xl transition-colors shadow-md active:scale-95 text-center">
                        Kembali ke Beranda
                    </a>
                    <a href="{{ url('/donasi') }}"
                        class="flex-1 bg-primary hover:bg-on-primary-fixed-variant text-on-primary font-label-sm text-label-sm px-8 py-4 rounded-xl transition-colors shadow-md active:scale-95 text-center">
                        Donasi Lagi
                    </a>
                </div>
            </div>
