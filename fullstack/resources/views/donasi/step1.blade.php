        ...
        <div class="max-w-2xl mx-auto px-margin-mobile md:px-margin-desktop">
            ...
            <div class="bg-surface-container-lowest rounded-3xl p-8 md:p-10 shadow-lg border border-outline-variant/20">
                ...
                <form action="{{ route('donasi.step2') }}" method="POST">
                    ...
                    <button type="submit"
                        class="w-full mt-8 bg-accent hover:bg-accent-hover text-on-accent font-label-sm text-base px-8 py-4 rounded-xl transition-all shadow-md active:scale-95 font-bold flex items-center justify-center gap-2">
