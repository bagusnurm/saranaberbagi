    ...
    <main class="flex-grow pt-[120px]">
        ...
        <section class="w-full px-margin-desktop py-section-padding max-w-container-max mx-auto">
            <div class="flex flex-col md:flex-row items-center gap-gutter">
                <div class="w-full md:w-1/2 flex flex-col gap-stack-lg">
                    <h1 class="font-h1 text-h1-mobile md:text-h1 text-on-surface leading-tight">Melayani dengan Hati,
                        Berbagi untuk Negeri</h1>
                    <p class="font-body-lg text-body-lg text-on-surface-variant max-w-lg">
                        Sarana Berbagi hadir sebagai jembatan kebaikan, menghubungkan kepedulian Anda dengan mereka yang
                ...
                <div class="w-full md:w-1/2">
                    <img alt="Relawan Sarana Berbagi"
                        ...
                        data-alt="A diverse group of dedicated volunteers in teal t-shirts smiling warmly while distributing relief packages in a rural Indonesian village. The scene is brightly lit with natural, golden hour sunlight, conveying hope, unity, and a professional yet deeply human-centric mood. The overall aesthetic is modern, clean, and optimistic, matching a trustworthy NGO brand identity."
        ...
        <section class="w-full px-margin-desktop py-section-padding bg-surface-container-lowest">
            <div class="max-w-container-max mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-gutter">
                    <!-- Visi -->
                    <div
                        class="bg-surface p-10 rounded-[24px] flex flex-col gap-stack-md border border-outline-variant/30 shadow-sm">
                        <div
                            class="w-14 h-14 bg-primary-container/20 rounded-full flex items-center justify-center text-primary mb-2">
                            <span class="material-symbols-outlined" data-icon="visibility">visibility</span>
                        </div>
                        <h2 class="font-h2 text-[28px] text-on-surface">Visi Kami</h2>
                        <p class="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">
                            Menjadi jembatan kebaikan yang profesional, transparan, dan terpercaya untuk mewujudkan
                    ...
                    <div
                        ...
                        <ul
                            class="font-body-lg text-body-lg text-on-surface-variant list-disc list-outside ml-5 space-y-3">
        ...
        <section class="w-full px-margin-desktop py-section-padding max-w-container-max mx-auto text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-gutter">
                ...
                <div class="flex flex-col items-center gap-stack-md">
                    <div
                        class="w-20 h-20 bg-secondary-container/30 text-primary rounded-full flex items-center justify-center mb-2">
                        <span class="material-symbols-outlined" data-icon="verified_user"
                            style="font-size: 36px;">verified_user</span>
                    </div>
                    <h3 class="font-h3 text-h3 text-on-surface">Transparansi</h3>
                    <p class="font-body-md text-body-md text-on-surface-variant max-w-xs mx-auto">Setiap donasi dikelola
                        secara terbuka dan dilaporkan secara berkala kepada publik.</p>
                </div>
                <!-- Profesionalisme -->
                <div class="flex flex-col items-center gap-stack-md">
                    <div
                        class="w-20 h-20 bg-secondary-container/30 text-primary rounded-full flex items-center justify-center mb-2">
                        <span class="material-symbols-outlined" data-icon="handshake"
                            style="font-size: 36px;">handshake</span>
                    </div>
                    <h3 class="font-h3 text-h3 text-on-surface">Profesionalisme</h3>
                    <p class="font-body-md text-body-md text-on-surface-variant max-w-xs mx-auto">Dikelola oleh tim yang
                        berdedikasi dan memiliki keahlian di bidang kemanusiaan.</p>
                </div>
                <!-- Kemanusiaan -->
                <div class="flex flex-col items-center gap-stack-md">
                    <div
                        ...
                        <span class="material-symbols-outlined" data-icon="favorite"
                            style="font-size: 36px;">favorite</span>
                    </div>
                    <h3 class="font-h3 text-h3 text-on-surface">Kemanusiaan</h3>
                    <p class="font-body-md text-body-md text-on-surface-variant max-w-xs mx-auto">Menjunjung tinggi
                        harkat dan martabat manusia tanpa membedakan latar belakang.</p>
                </div>
            </div>
        </section>
        <!-- Sejarah Section -->
        <section class="w-full px-margin-desktop py-section-padding bg-surface-container-high/30">
            <div class="max-w-container-max mx-auto max-w-4xl text-center flex flex-col gap-stack-lg">
                ...
                <p class="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">
                    Dimulai pada tahun 2016 dari sebuah inisiatif kecil, Sarana Berbagi lahir dari keprihatinan melihat
                    kesenjangan sosial yang nyata di sekitar kita.
                </p>
                <p class="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                    Berawal dari komunitas relawan mahasiswa, kami kini telah berkembang menjadi organisasi profesional
                    yang berbadan hukum. Selama perjalanannya, Sarana Berbagi berkomitmen untuk terus menjadi jembatan
                    yang menghubungkan kebaikan hati para donatur dengan senyum kebahagiaan mereka yang membutuhkan di
        ...
        <!-- CTA Section -->
        <section
            class="w-full px-margin-desktop py-section-padding max-w-container-max mx-auto text-center flex flex-col items-center gap-stack-lg">
            <h2 class="font-h1 text-h1-mobile md:text-h1 text-on-surface">Mari Berkontribusi</h2>
            <p class="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
                Setiap kebaikan yang Anda bagikan akan membawa perubahan nyata bagi mereka yang membutuhkan.
                Bergabunglah bersama kami sekarang.
            </p>
            <a class="bg-[#F59E0B] text-white font-label-sm text-label-sm px-8 py-4 rounded-lg hover:bg-opacity-90 transition-opacity duration-200 shadow-md"
                href="{{ url('/donasi') }}">
                Donasi Sekarang
            </a>
        </section>
