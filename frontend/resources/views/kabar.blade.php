...
<body class="bg-background text-on-background antialiased selection:bg-primary-container selection:text-on-primary-container flex flex-col min-h-screen">
<!-- TopNavBar -->
<nav class="fixed top-0 w-full z-50 bg-surface/90 backdrop-blur-md dark:bg-on-background/90 border-b border-outline-variant/30 shadow-sm dark:shadow-none transition-all duration-300"><div class="max-w-container-max mx-auto px-margin-desktop flex justify-between items-center h-20"><div class="flex items-center gap-4"><a class="flex items-center" href="{{ url('/') }}"><img alt="Sarana Berbagi Logo" class="h-28 w-auto object-contain" src="{{ asset('img/PROPERTY (2).png') }}"></a></div><div class="hidden md:flex items-center gap-6"><a class="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors hover:bg-surface-container-low dark:hover:bg-inverse-surface rounded-lg px-3 py-2 active:scale-95 duration-200 font-body-md text-body-md" href="{{ url('/') }}">Tentang Kami</a><a class="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors hover:bg-surface-container-low dark:hover:bg-inverse-surface rounded-lg px-3 py-2 active:scale-95 duration-200 font-body-md text-body-md" href="{{ url('/program') }}">Program</a><a class="text-primary dark:text-primary-fixed font-semibold border-b-2 border-primary dark:border-primary-fixed pb-1 px-3 py-2 active:scale-95 duration-200 font-body-md text-body-md" href="{{ url('/kabar') }}">Kabar</a><a class="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors hover:bg-surface-container-low dark:hover:bg-inverse-surface rounded-lg px-3 py-2 active:scale-95 duration-200 font-body-md text-body-md" href="{{ url('/karir') }}">Karir</a><a class="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors hover:bg-surface-container-low dark:hover:bg-inverse-surface rounded-lg px-3 py-2 active:scale-95 duration-200 font-body-md text-body-md" href="{{ url('/digital-collaborators') }}">Digital Collaborators</a></div><div class="flex items-center gap-4"><a class="bg-[#F59E0B] text-white font-label-sm text-label-sm px-6 py-3 rounded-lg hover:bg-[#D97706] transition-colors shadow-sm active:scale-95" href="{{ url('/donasi') }}">Donasi</a></div></div></nav>
...
<p class="font-body-lg text-body-lg text-on-surface-variant mb-10">Kisah inspiratif, pembaruan program, dan dampak yang kita ciptakan bersama untuk kemanusiaan.</p>
...
<input class="w-full bg-surface-container-lowest border border-outline-variant rounded-xl py-4 pl-12 pr-4 font-body-md text-body-md text-on-surface placeholder:text-outline-variant focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all shadow-sm" placeholder="Cari artikel, berita, atau topik..." type="text">
</div>
</div>
<!-- Categories -->
<div class="flex flex-wrap justify-center gap-4 mb-16">
<button class="px-6 py-2 rounded-full bg-primary/10 text-primary font-label-sm text-label-sm border border-primary/20 hover:bg-primary/20 transition-colors">Semua</button>
<button class="px-6 py-2 rounded-full bg-surface-container text-on-surface-variant font-label-sm text-label-sm border border-outline-variant hover:border-primary/50 transition-colors">Edukasi</button>
<button class="px-6 py-2 rounded-full bg-surface-container text-on-surface-variant font-label-sm text-label-sm border border-outline-variant hover:border-primary/50 transition-colors">Kesehatan</button>
<button class="px-6 py-2 rounded-full bg-surface-container text-on-surface-variant font-label-sm text-label-sm border border-outline-variant hover:border-primary/50 transition-colors">Tanggap Bencana</button>
<button class="px-6 py-2 rounded-full bg-surface-container text-on-surface-variant font-label-sm text-label-sm border border-outline-variant hover:border-primary/50 transition-colors">Kisah Sukses</button>
</div>
<!-- Grid -->
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
<!-- Card 1 -->
<article class="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.05)] hover:shadow-[0_10px_30px_rgba(15,23,42,0.08)] transition-all duration-300 group border border-outline-variant/20 flex flex-col cursor-pointer" data-id="1">
<div class="relative h-60 overflow-hidden">
<img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-alt="A bright, modern photograph of children in a rural Indonesian classroom, smiling and holding new books. The lighting is warm and natural, emphasizing hope and education. A soft, optimistic teal hue permeates the scene, aligning with a professional NGO brand." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCtWbu662_2iNprm3alF0kRYaVnj_AcLjFaNMAdEanEt2kEPtK10neEJan1lIlnwR0Eypa7X933lr30xQDo2kPIpvy5vbHdxhWVz_WUmZ5V0ZOhrhhW6CsZDNtTT2ytO-ejtCGhSfOm_pDszAGOBLyGxmF0uUg_vsbRpn1pRFdEPbUVSh3_s2HCVasEhtvOHnfA53Oaqh9HYqw5Jm-_DVNyYrKEdax3YR76z9irRp8-OLMANMDmpf_Hjg">
<div class="absolute top-4 left-4 bg-surface/90 backdrop-blur-sm px-3 py-1 rounded-full font-label-sm text-label-sm text-primary">Edukasi</div>
</div>
...
<h3 class="font-h3 text-h3 text-on-surface mb-3 group-hover:text-primary transition-colors line-clamp-2">Perpustakaan Keliling Tiba di Desa Harapan</h3>
<p class="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-3 flex-grow">Membawa ratusan buku baru, relawan kami menghabiskan akhir pekan berbagi cerita dan pengetahuan dengan anak-anak di pelosok.</p>
<a class="kabar-detail-link inline-flex items-center gap-2 text-primary font-label-sm text-label-sm hover:underline mt-auto" data-id="1" href="javascript:void(0)">
                            Baca Selengkapnya <span class="material-symbols-outlined text-[18px]">arrow_forward</span>
                        </a>
</div>
</article>
<!-- Card 2 -->
<article class="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.05)] hover:shadow-[0_10px_30px_rgba(15,23,42,0.08)] transition-all duration-300 group border border-outline-variant/20 flex flex-col cursor-pointer" data-id="2">
<div class="relative h-60 overflow-hidden">
<img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-alt="A clean, documentary-style photo of a mobile health clinic in a sunny, tropical village. Medical staff in crisp white and teal uniforms are assisting elderly residents. The image is bright, professional, and optimistic, capturing a moment of care and community support." src="https://lh3.googleusercontent.com/aida-public/AB6AXuB8JJYQSs4hSDhny6bWDq6C8tL3CNgX5Vuo1ax6SXD7haKd-UsCujEce-pTHKwoo6VkHNvJXtOqp2kzfKzKKC0AwuCXUPyvkA4DcGVjpaS0_bnQPztiHVcvJR41noQ0TBjThu9b9ooLtoZnPcACgbqsz99OPlt4V81lqJa-G2jxfISH0EZeipYnJkwiAg7OOAKDN8eK-KzpCv4RI_RHxQS9RyOUXjrLgmWWTTK4P7rlX-g1YcQgz8s3qA">
<div class="absolute top-4 left-4 bg-surface/90 backdrop-blur-sm px-3 py-1 rounded-full font-label-sm text-label-sm text-primary">Kesehatan</div>
</div>
<div class="p-6 flex flex-col flex-grow">
<div class="flex items-center gap-2 text-outline font-label-sm text-label-sm mb-3">
...
<h3 class="font-h3 text-h3 text-on-surface mb-3 group-hover:text-primary transition-colors line-clamp-2">Klinik Berjalan Melayani 500 Warga Lansia</h3>
<p class="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-3 flex-grow">Program pemeriksaan kesehatan gratis kami bulan ini berfokus pada kesejahteraan lansia di daerah terpencil dengan akses medis terbatas.</p>
<a class="kabar-detail-link inline-flex items-center gap-2 text-primary font-label-sm text-label-sm hover:underline mt-auto" data-id="2" href="javascript:void(0)">
                            Baca Selengkapnya <span class="material-symbols-outlined text-[18px]">arrow_forward</span>
                        </a>
</div>
</article>
<!-- Card 3 -->
<article class="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.05)] hover:shadow-[0_10px_30px_rgba(15,23,42,0.08)] transition-all duration-300 group border border-outline-variant/20 flex flex-col cursor-pointer" data-id="3">
<div class="relative h-60 overflow-hidden">
<img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-alt="A powerful, uplifting photo of volunteers handing out clean water supplies after a natural disaster. The scene is lit with natural daylight, showing resilience. The volunteers wear teal vests, harmonizing with the brand's primary color palette. Professional and hopeful aesthetic." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAuNn8SWz1-gb07ckiocA_tz4YyBPpeSOB0GqDB6zpekTROOVs2bQyPVfSG3Q83l7bR_9EaI520iHc20SCs_7r-PozeQuw2SuRHS5KKUrAxW8Lr3jfKeog6_ABuSg-CsQG51Px9e-izEL6jfRGys928Hi7Vtp5xxsjim09TgWk-rLUNNRyLbntLf1UR65QpcMtYUxXKxF4ul1kiVpNLNkaPhW5LVjTBo-Ww7TNYDU_2CBZuOQKdMJifvA">
<div class="absolute top-4 left-4 bg-surface/90 backdrop-blur-sm px-3 py-1 rounded-full font-label-sm text-label-sm text-primary">Tanggap Bencana</div>
</div>
<div class="p-6 flex flex-col flex-grow">
<div class="flex items-center gap-2 text-outline font-label-sm text-label-sm mb-3">
...
<h3 class="font-h3 text-h3 text-on-surface mb-3 group-hover:text-primary transition-colors line-clamp-2">Distribusi Air Bersih Pasca Gempa</h3>
<p class="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-3 flex-grow">Tim reaksi cepat Sarana Berbagi telah mendirikan 5 titik distribusi air bersih untuk membantu keluarga yang terdampak.</p>
<a class="kabar-detail-link inline-flex items-center gap-2 text-primary font-label-sm text-label-sm hover:underline mt-auto" data-id="3" href="javascript:void(0)">
                            Baca Selengkapnya <span class="material-symbols-outlined text-[18px]">arrow_forward</span>
                        </a>
</div>
</article>
<!-- Card 4 -->
<article class="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.05)] hover:shadow-[0_10px_30px_rgba(15,23,42,0.08)] transition-all duration-300 group border border-outline-variant/20 flex flex-col cursor-pointer" data-id="4">
<div class="relative h-60 overflow-hidden">
<img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-alt="A beautiful, well-lit portrait of an Indonesian woman farmer smiling proudly in her green vegetable field. The lighting highlights her resilience and success. The color palette features rich natural greens and warm earthy tones, reflecting sustainable agriculture and empowerment." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDnUwyD1IG2V_5-KpX5REOEkQ1TJUmzH45nYDaS3GZX28ZbCZFjLNAkraX35GfZE9ik_H7-aAp1x2d6FnNKxC6slZh6uLt_mjTy000dQjAo012tmYPGS5FZCrlhNSqa5UGUyoS9EggmptVvxnVH4P-e8J-sUAtmYa70IL_FZ8bRyRHAvUgC9_paPavpgSdzQYiJRwwK3cmP1XqmyDZrA9x-C4d-UiUPxyxG2AGcHl5I8mbIHWk_PPPwLA">
<div class="absolute top-4 left-4 bg-surface/90 backdrop-blur-sm px-3 py-1 rounded-full font-label-sm text-label-sm text-primary">Kisah Sukses</div>
</div>
<div class="p-6 flex flex-col flex-grow">
<div class="flex items-center gap-2 text-outline font-label-sm text-label-sm mb-3">
...
<h3 class="font-h3 text-h3 text-on-surface mb-3 group-hover:text-primary transition-colors line-clamp-2">Ibu Siti: Mengubah Lahan Kering Menjadi Kebun Produktif</h3>
<p class="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-3 flex-grow">Berkat program pemberdayaan ekonomi, Ibu Siti kini menjadi pemasok sayur organik utama di desanya.</p>
<a class="kabar-detail-link inline-flex items-center gap-2 text-primary font-label-sm text-label-sm hover:underline mt-auto" data-id="4" href="javascript:void(0)">
                            Baca Selengkapnya <span class="material-symbols-outlined text-[18px]">arrow_forward</span>
                        </a>
</div>
</article>
<!-- Card 5 -->
<article class="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.05)] hover:shadow-[0_10px_30px_rgba(15,23,42,0.08)] transition-all duration-300 group border border-outline-variant/20 flex flex-col cursor-pointer" data-id="5">
<div class="relative h-60 overflow-hidden">
<img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-alt="A modern, bright photograph showing young volunteers painting a school building. The aesthetic is clean, energetic, and hopeful. Volunteers are engaged and smiling, wearing subtle teal accents that match the NGO's primary branding. Sunlit and optimistic." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBsm8hA1U-3AAbSwvylFj_0Q3-WZ32YI3BI1aGX6pBxjPWKONrbzltHZ688eibuH9pTPqUOCv1EJ9mKuPD9eIbTVFxuAtfVSLFt_oWVWxDVGhfjPbzLflLad9v-3z7rUB7kKSkP5iHUolZ1tI4RC3mCfq3eQ_lr8g2rVTWSh_QZyrAbaRWV5G6V7zHn91AfYbvnjONdk7ajGfOq6LoQjJ410F7xwrHAaj1IFzOM23J1_l-ACXqQ3cY_Bg">
<div class="absolute top-4 left-4 bg-surface/90 backdrop-blur-sm px-3 py-1 rounded-full font-label-sm text-label-sm text-primary">Edukasi</div>
</div>
<div class="p-6 flex flex-col flex-grow">
<div class="flex items-center gap-2 text-outline font-label-sm text-label-sm mb-3">
...
<h3 class="font-h3 text-h3 text-on-surface mb-3 group-hover:text-primary transition-colors line-clamp-2">Renovasi SD Inpres Selesai Lebih Cepat</h3>
<p class="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-3 flex-grow">Antusiasme puluhan relawan lokal membuat proses perbaikan fasilitas sekolah ini rampung sebelum tahun ajaran baru dimulai.</p>
<a class="kabar-detail-link inline-flex items-center gap-2 text-primary font-label-sm text-label-sm hover:underline mt-auto" data-id="5" href="javascript:void(0)">
                            Baca Selengkapnya <span class="material-symbols-outlined text-[18px]">arrow_forward</span>
                        </a>
</div>
</article>
<!-- Card 6 -->
<article class="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.05)] hover:shadow-[0_10px_30px_rgba(15,23,42,0.08)] transition-all duration-300 group border border-outline-variant/20 flex flex-col cursor-pointer" data-id="6">
<div class="relative h-60 overflow-hidden">
<img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-alt="A high-quality, calm photo of solar panels being installed on a community center roof in a rural setting. Clear blue sky above. The image conveys sustainable development and progress. Colors are bright, clean, and incorporate subtle teal and white tones." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBJ2qwp5lEwfGe0FhFBQkcUck3kLYfEZiogCmY-s3pBlurTSW-XdavlPf-IFBxjvUZgQikWOejKgnwbf_-7GbTeB-UqUbwolsG_wBmbg1M7eO7lJ2h8Rvsj1LaGOpYZnddiiLBIO7-rYWvqI22gDZI8Q1Pq2vwEui8Ev8fOhFrS_X0IxXAK2MlIJJB91K4nIBpUwU75mTKb86NIM5KEEZA0ERWyoCR2yanArahqK8ACDKlQJV9fMwVUhg">
<div class="absolute top-4 left-4 bg-surface/90 backdrop-blur-sm px-3 py-1 rounded-full font-label-sm text-label-sm text-primary">Kabar</div>
</div>
<div class="p-6 flex flex-col flex-grow">
<div class="flex items-center gap-2 text-outline font-label-sm text-label-sm mb-3">
...
<h3 class="font-h3 text-h3 text-on-surface mb-3 group-hover:text-primary transition-colors line-clamp-2">Panel Surya Untuk Balai Desa Terang</h3>
<p class="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-3 flex-grow">Inisiatif energi bersih kami mulai menunjukkan hasil. Malam hari di balai desa kini bisa dimanfaatkan untuk kegiatan belajar warga.</p>
<a class="kabar-detail-link inline-flex items-center gap-2 text-primary font-label-sm text-label-sm hover:underline mt-auto" data-id="6" href="javascript:void(0)">
                            Baca Selengkapnya <span class="material-symbols-outlined text-[18px]">arrow_forward</span>
                        </a>
</div>
</article>
...
<button class="w-10 h-10 rounded-full flex items-center justify-center border border-outline-variant text-outline hover:border-primary hover:text-primary transition-colors cursor-not-allowed opacity-50" disabled="">
<span class="material-symbols-outlined">chevron_left</span>
</button>
<button class="w-10 h-10 rounded-full flex items-center justify-center bg-primary text-on-primary font-label-sm text-label-sm shadow-sm">1</button>
<button class="w-10 h-10 rounded-full flex items-center justify-center border border-outline-variant text-on-surface hover:border-primary hover:text-primary transition-colors font-label-sm text-label-sm">2</button>
<button class="w-10 h-10 rounded-full flex items-center justify-center border border-outline-variant text-on-surface hover:border-primary hover:text-primary transition-colors font-label-sm text-label-sm">3</button>
<span class="text-outline mx-1">...</span>
<button class="w-10 h-10 rounded-full flex items-center justify-center border border-outline-variant text-on-surface hover:border-primary hover:text-primary transition-colors font-label-sm text-label-sm">8</button>
<button class="w-10 h-10 rounded-full flex items-center justify-center border border-outline-variant text-on-surface hover:border-primary hover:text-primary transition-colors">
...
<button class="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-surface-container-low hover:bg-surface-variant flex items-center justify-center text-on-surface-variant hover:text-on-surface transition-colors" onclick="closeKabarPopup()">
...
<img alt="Sarana Berbagi Logo" class="h-12 w-auto bg-white rounded-full p-1" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBkVq0f0LLfYS7dU8RJGU5KzjD5Wr3nj7lSxJVutV2aleHZ4DBlOopaEMpMAsOdwKw__VEBN39NDKDNb0AxA34KayLOYKp7bv1cTyZK0p1g07LPKPiF-tOeEckswVX6QTiDDpDJQSFwOaIqINe04sRMpBg8TQwOrHSlE0YT1uUKhX6IL2liYA66XpuKleso30IWhQxDjGK23EVglVKCDKxHstHgr48wTumBGutS0GsqK4vqUbbV8Tja9Q6qEcEWlxbXigM">
...
<p class="font-body-md text-sm leading-relaxed text-white/90 max-w-xs">
                        Sarana Berbagi adalah lembaga professional berlokasi di Kota Bandung yang bergerak di bidang sosial dan pendidikan.
                    </p>
</div>
...
<img alt="Map Location" class="w-full h-full object-cover grayscale opacity-80 mix-blend-multiply" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDwbSQ6aKCbEBC-2X0avJDgu_xHWPfpejdw63Vq29Ju1OnI9kQ7sdNeVM0QhAWMPZxAI7Q9c85Bibj3m43pJGdiHRLeh8zOwx0eCI9OEWvAngbnFxy13LUrWGztCteJaNjS-kMLtQcoVeQqMBHecOSdYd9uHJoh18xyFL6l-kj9-SRRjOVH5p4O_k62Oq8Jy2Dyt5tCFQx4xN5F-UlRTRV2ZO-BS-wafarPP5HzQ6lgfI3iQg0UmZoVrw">
</div>
</div>
</div>
</footer>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    popup.addEventListener('mouseleave', function() { closeKabarPopup(); });
});

document.addEventListener('keydown', function(e) { if (e.key === 'Escape') closeKabarPopup(); });
</script>
</body></html>
