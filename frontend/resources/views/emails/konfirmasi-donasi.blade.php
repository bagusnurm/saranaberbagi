...
<head>
    ...
    <style>
        ...
        .header { background-color: #005c55; color: #ffffff; padding: 30px; text-align: center; }
        .header h1 { margin: 0; font-size: 24px; font-weight: 700; }
        .header p { margin: 10px 0 0; opacity: 0.9; }
        .content { padding: 30px; }
        .info-table { width: 100%; border-collapse: collapse; margin: 20px 0; }
        .info-table td { padding: 12px 15px; border-bottom: 1px solid #e9ecef; }
        .info-table td:first-child { font-weight: 600; color: #495057; width: 40%; }
        .info-table td:last-child { color: #212529; }
        .nominal { font-size: 28px; font-weight: 700; color: #005c55; text-align: center; padding: 20px; background-color: #f2f3ff; border-radius: 8px; margin: 20px 0; }
        .footer { background-color: #f8f9fa; padding: 20px; text-align: center; color: #6c757d; font-size: 14px; }
        .btn { display: inline-block; background-color: #005c55; color: #ffffff; padding: 12px 30px; border-radius: 6px; text-decoration: none; font-weight: 600; margin-top: 20px; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Jika ada pertanyaan, hubungi kami di <strong>0818-0953-1647</strong> atau email <strong>yayasansaranaberbagi@gmail.com</strong>.</p>
        ...
        <div class="footer">
            ...
            <p style="font-size: 12px; color: #999;">Komplek Griya Bandung Indah Blok F 19 No 10, Bandung, Jawa Barat 40287</p>
        </div>
    </div>
</body>
</html>
