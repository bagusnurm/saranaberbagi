...
<main class="flex-grow pt-32 pb-section-padding">
    <div class="max-w-2xl mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div class="flex items-center justify-center mb-12">
            ...
            <div class="flex items-center">
                <div class="w-10 h-10 rounded-full bg-outline-variant text-on-surface-variant flex items-center justify-center font-bold">2</div>
        ...
        <div class="bg-surface-container-lowest rounded-2xl p-8 md:p-10 shadow-lg border border-outline-variant/20">
            ...
            <p class="text-on-surface-variant text-center mb-8">Silakan isi data diri Anda untuk melanjutkan donasi</p>
            ...
            <form action="{{ route('donasi.step2') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="nama" required class="w-full bg-surface border border-outline-variant rounded-xl py-3 px-4 font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" placeholder="Masukkan nama lengkap">
                    </div>
                    <div>
                        <label class="block font-label-sm text-label-sm text-on-surface mb-2">Email *</label>
                        <input type="email" name="email" required class="w-full bg-surface border border-outline-variant rounded-xl py-3 px-4 font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" placeholder="contoh@email.com">
                    </div>
                    <div>
                        <label class="block font-label-sm text-label-sm text-on-surface mb-2">Nomor Telepon *</label>
                        <input type="tel" name="telepon" required class="w-full bg-surface border border-outline-variant rounded-xl py-3 px-4 font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" placeholder="08xxxxxxxxxx">
                    </div>
                    <div>
                        <label class="block font-label-sm text-label-sm text-on-surface mb-2">Nominal Donasi (Rp) *</label>
                        <input type="number" name="nominal" required min="10000" class="w-full bg-surface border border-outline-variant rounded-xl py-3 px-4 font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" placeholder="Minimal Rp 10.000">
                    ...
                    <div>
                        ...
                        <textarea name="pesan" rows="3" class="w-full bg-surface border border-outline-variant rounded-xl py-3 px-4 font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all resize-none" placeholder="Tulis pesan atau doa (opsional)"></textarea>
                    </div>
                </div>
                <button type="submit" class="w-full mt-8 bg-[#F59E0B] hover:bg-[#D97706] text-white font-label-sm text-label-sm px-8 py-4 rounded-xl transition-colors shadow-md active:scale-95">
